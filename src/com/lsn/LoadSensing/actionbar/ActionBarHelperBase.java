...
public class ActionBarHelperBase extends ActionBarHelper {
	...
	public void setFavesActionItem(boolean faves) {
		...
		ImageButton starButton = (ImageButton) mActivity
				.findViewById(R.id.actionbar_compat_item_faves);
		if (starButton != null) {

			starButton.setImageResource(faves ? R.drawable.ic_action_star_off
	...
	public void optionsMenuInfo(Menu menu) {
		...
		// Add info icon on physical menu button
		menu.add(Menu.NONE, R.id.menu_info, Menu.NONE, R.string.menu_info)
		.setIcon(R.drawable.ic_action_info);
	}
	
	public void optionsMenuConfig(Menu menu) {

		// Add config icon on physical menu button
