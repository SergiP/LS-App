...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
    	...
    	// add info and config icons on physical menu button
    	menu.add(Menu.NONE, R.id.menu_info, Menu.NONE, R.string.menu_info).setIcon(R.drawable.ic_action_info_green_droid);
    	menu.add(Menu.NONE,R.id.menu_config, Menu.NONE, R.string.menu_config).setIcon(R.drawable.ic_action_settings_green_droid);
     ...
     * {@link com.lsn.LoadSensing.actionbar.example.android.actionbarcompat.ActionBarHelperBase#setRefreshActionItemState(boolean)}.
     */
    ...
    public void changeIconHome() {
    	...
    	// Cambiar icono home por uno con el simbolo "<icono"
        ...
        SimpleMenuItem homeItem = new SimpleMenuItem(
                tempMenu, android.R.id.home, 0, mActivity.getString(R.string.app_name));
        homeItem.setIcon(R.drawable.ic_action_exit);
        addActionItemCompatFromMenuItem(homeItem);*/
    }
