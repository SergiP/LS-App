package com.lsn.LoadSensing.filter;
...
public class FilterAdapter<T extends ListFilter> extends BaseAdapter implements Filterable{
     ...
     */
    public FilterAdapter(Context context, int textViewResourceId, T[] objects) {
     ...
     * @param objects The objects to represent in the ListView.
     */
    public FilterAdapter(Context context, int textViewResourceId, List<T> objects) {
        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            if (prefix == null || prefix.length() == 0) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    //final String valueText = value.getComparableString().toString().toLowerCase();

                    // First match against the whole, non-splitted value
                    //if (valueText.startsWith(prefixString)) {
                    if(value.filterThisListItem(prefixString)){
                        newValues.add(value);
                    } 
                }
