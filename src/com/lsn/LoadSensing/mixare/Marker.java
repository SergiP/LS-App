 ...
 */
package com.lsn.LoadSensing.mixare;
...
import com.lsn.LoadSensing.mixare.gui.ScreenLine;
import com.lsn.LoadSensing.mixare.gui.ScreenObj;
import com.lsn.LoadSensing.mixare.gui.TextObj;
import com.lsn.LoadSensing.mixare.reality.PhysicalPlace;
import com.lsn.LoadSensing.mixare.render.Camera;
import com.lsn.LoadSensing.mixare.render.MixVector;
...
//	}
	...
	public boolean fClick(float x, float y, MixContext ctx, MixState state) {
		...
		if (isClickValid(x, y)) {
			//LSN Modification Init
			//evtHandled = state.handleEvent(ctx, URL);
			evtHandled = state.handleEvent(ctx, NETID);
			//LSN Modification End
		}
		return evtHandled;
	}
